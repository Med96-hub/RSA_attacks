...
pp0=rdp(750); qq0=rdp(750); p=max(pp0,qq0); q=min(pp0,qq0)
print('p=',p) 
print('\n')
...
epsilon=numerical_approx(log(abs(p-p0))/log(N),digits=5);
gamma=numerical_approx(log(abs(s))/log(N),digits=5);
print('\n')
